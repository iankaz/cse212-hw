...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The first person returned is <Sue> instead of <Bob>. The queue order is incorrect.
    ...
    // Defect(s) Found: The first person returned is <Sue> instead of <Tim>. The queue order is incorrect.
    ...
    // Defect(s) Found: Not tested due to earlier failures, but should check for correct exception message.
